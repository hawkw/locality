...
pub use core::hint::unreachable_unchecked as unreachable;

#[cfg(debug_assertions)]
pub fn unreachable() -> ! {
    unreachable!(
        "entered code believed to be unreachable.\n
        in release mode, this would have been `unreachable_unchecked`, \
        which could result in undefined behavior.\n
        THIS IS A BUG (and potentially, quite serious). please report this to \
        the `locality` maintainers immediately! thank you!"
    )
}
